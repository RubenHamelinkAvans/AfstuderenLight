...
namespace OrderServiceTests.Unit.Services
{
    public class OrderServiceTests
    {
        ...
        public void Setup()
        {
            ...
            orderService = new OrderService.Services.OrderService(customerServiceMock.Object, repositoryMock.Object);
        }
